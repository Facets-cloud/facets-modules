...
data "aws_vpc_endpoint_service" "s3" {
  count = var.create_components && var.enable_s3_endpoint ? 1 : 0
...
resource "aws_vpc_endpoint_route_table_association" "private_s3" {
  count = var.create_components && var.enable_s3_endpoint ? local.nat_gateway_count : 0
...
resource "aws_vpc_endpoint_route_table_association" "intra_s3" {
  count = var.create_components && var.enable_s3_endpoint && length(var.intra_subnets) > 0 ? 1 : 0
...
resource "aws_vpc_endpoint_route_table_association" "public_s3" {
  count = var.create_components && var.enable_s3_endpoint && length(var.public_subnets) > 0 ? 1 : 0
...
data "aws_vpc_endpoint_service" "dynamodb" {
  count = var.create_components && var.enable_dynamodb_endpoint ? 1 : 0
...
resource "aws_vpc_endpoint_route_table_association" "private_dynamodb" {
  count = var.create_components && var.enable_dynamodb_endpoint ? local.nat_gateway_count : 0
...
resource "aws_vpc_endpoint_route_table_association" "intra_dynamodb" {
  count = var.create_components && var.enable_dynamodb_endpoint && length(var.intra_subnets) > 0 ? 1 : 0
...
resource "aws_vpc_endpoint_route_table_association" "public_dynamodb" {
  count = var.create_components && var.enable_dynamodb_endpoint && length(var.public_subnets) > 0 ? 1 : 0
...
data "aws_vpc_endpoint_service" "codebuild" {
  count = var.create_components && var.enable_codebuild_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "codecommit" {
  count = var.create_components && var.enable_codecommit_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "git_codecommit" {
  count = var.create_components && var.enable_git_codecommit_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "config" {
  count = var.create_components && var.enable_config_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "sqs" {
  count = var.create_components && var.enable_sqs_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "secretsmanager" {
  count = var.create_components && var.enable_secretsmanager_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ssm" {
  count = var.create_components && var.enable_ssm_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ssmmessages" {
  count = var.create_components && var.enable_ssmmessages_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ec2" {
  count = var.create_components && var.enable_ec2_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ec2messages" {
  count = var.create_components && var.enable_ec2messages_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "transferserver" {
  count = var.create_components && var.enable_transferserver_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ecr_api" {
  count = var.create_components && var.enable_ecr_api_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ecr_dkr" {
  count = var.create_components && var.enable_ecr_dkr_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "apigw" {
  count = var.create_components && var.enable_apigw_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "kms" {
  count = var.create_components && var.enable_kms_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ecs" {
  count = var.create_components && var.enable_ecs_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ecs_agent" {
  count = var.create_components && var.enable_ecs_agent_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "ecs_telemetry" {
  count = var.create_components && var.enable_ecs_telemetry_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "sns" {
  count = var.create_components && var.enable_sns_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "monitoring" {
  count = var.create_components && var.enable_monitoring_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "logs" {
  count = var.create_components && var.enable_logs_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "events" {
  count = var.create_components && var.enable_events_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "elasticloadbalancing" {
  count = var.create_components && var.enable_elasticloadbalancing_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "cloudtrail" {
  count = var.create_components && var.enable_cloudtrail_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "kinesis_streams" {
  count = var.create_components && var.enable_kinesis_streams_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "kinesis_firehose" {
  count = var.create_components && var.enable_kinesis_firehose_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "glue" {
  count = var.create_components && var.enable_glue_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "sagemaker_notebook" {
  count = var.create_components && var.enable_sagemaker_notebook_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "sts" {
  count = var.create_components && var.enable_sts_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "cloudformation" {
  count = var.create_components && var.enable_cloudformation_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "codepipeline" {
  count = var.create_components && var.enable_codepipeline_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "appmesh_envoy_management" {
  count = var.create_components && var.enable_appmesh_envoy_management_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "servicecatalog" {
  count = var.create_components && var.enable_servicecatalog_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "storagegateway" {
  count = var.create_components && var.enable_storagegateway_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "transfer" {
  count = var.create_components && var.enable_transfer_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "sagemaker_api" {
  count = var.create_components && var.enable_sagemaker_api_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "sagemaker_runtime" {
  count = var.create_components && var.enable_sagemaker_runtime_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "appstream" {
  count = var.create_components && var.enable_appstream_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "athena" {
  count = var.create_components && var.enable_athena_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "rekognition" {
  count = var.create_components && var.enable_rekognition_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "efs" {
  count = var.create_components && var.enable_efs_endpoint ? 1 : 0
...
data "aws_vpc_endpoint_service" "cloud_directory" {
  count = var.create_components && var.enable_cloud_directory_endpoint ? 1 : 0
