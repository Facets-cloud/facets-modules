      ...
      dynamic "statement" {
        ...
        content {
          ...
          dynamic "rule_group_reference_statement" {
            for_each = lookup(statement.value, "rule_group_reference_statement", null) != null ? { rule_group_reference_statement = lookup(statement.value, "rule_group_reference_statement", {}) } : {}
            content {
