...
Kubernetes Gateway API implementation for Azure with Azure Load Balancer and DNS-01 support.
...
|---|---|---|---|
| No cert ref + `use_dns01: true` | cert-manager DNS-01 via ClusterIssuer | Wildcard (`*.domain`) | Azure wrapper |
