variable "instance" {
  ...
  type = object({
    kind    = string   # Specifies the intent of the module, such as `auth`, `logging`, etc.
    flavor  = string   # Indicates the specific implementation of the intent, such as `standard`, `advanced`, etc.
